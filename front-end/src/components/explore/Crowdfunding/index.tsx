...
const Crowdfunding = () => {
  ...
  return (
    <>
      <Nav3 />
      <div className="flex justify-center mb-6 p-6 md:p-12 lg:p-24" style={{ background: "#BDE3F0" }}>
          <div className="text-sm border py-8 px-8 max-w-xl rounded-md flex flex-col gap-4 shadow border-gray-600 shadow-2xl md:mt-52 mt-60" style={{ background: "#0F4C81" }}>
            ...
            <div>
              {mintingDone ? (
                <div className="flex gap-3">
                  <Button variant="secondary" size="sm" style={{ background: "white", color: "black", borderRadius: "999px" }}>
                    Withdraw Funds
                  </Button>
                  <Button variant="secondary" size="sm" style={{ background: "white", color: "black", borderRadius: "999px" }}>
                    Dispute
                ...
                <div className="mt-4">
                  {isStaked && (
                    <Button variant="primary" size="md" onClick={handleMint} style={{ background: "white", color: "black", borderRadius: "999px" }}>
                      {isMinting ? "Minting..." : "Mint NFT"}
                    </Button>
                  )}
                  {!isStaked && (
                    <Button variant="primary" size="md" onClick={handleStake} style={{ background: "white", color: "black", borderRadius: "999px" }}>
            ...
            {isStaked && (
              <div className="mt-4">
                ...
                <div className="w-full h-4 bg-gray-300 rounded">
                  <div style={{ width: `${5}%` }} className="h-full bg-blue-500 rounded"></div>
                </div>
                <p>{2 / 5} USDC</p>
              </div>
            )}
